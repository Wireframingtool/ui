...
export class Editor extends React.Component<EditorProps> {
  ...
  private initDiagramScope = (doc: svg.Doc) => {
    ...
    this.interactionService = new InteractionService(
      [this.adornersSelect, this.adornersTransform],
      this.diagramRendering,
      doc
    );
  ...
  private forceRender() {
    ...
    for (const shape of allShapes) {
      ...
      if (!ref) {
        const renderer =
          this.props.rendererService.registeredRenderers[shape.renderer];
  ...
  public render() {
    ...
    const style: React.CSSProperties = {
      position: "relative",
      width: sizeInPx(zoomedSize.x),
      height: sizeInPx(zoomedSize.y),
    };
