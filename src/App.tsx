...
import { Pages } from "./wireframes/components/assets/Pages";
...
export const App = () => {
  ...
  const doSelectTab = React.useCallback(
    (key: string) => {
      ...
      <Layout className="screen-mode">
        ...
        <Layout className="content">
          ...
          >
            <Collapse
              bordered={false}
              defaultActiveKey={["layout", "visual", "custom"]}
            >
          ...
          <Button
            icon={<ToggleIcon left={showLeftSidebar} />}
          ...
          <Button
            icon={<ToggleIcon left={!showRightSidebar} />}
